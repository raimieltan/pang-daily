...
/** Short north-street sprint with one readable right bend. Last waypoint is beyond the finish. */
export const LOCAL_ROUTE: RaceDefinition = {
  ...
  waypoints: filletPolyline([{ x: -65, z: 142, width: 9 }, { x: 122, z: 142, width: 9 }, { x: 122, z: 55, width: 9 }], 24)
