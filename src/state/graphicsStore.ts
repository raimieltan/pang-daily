...
import type { GameEventMap, GameEventSource, GraphicsSettings, RenderStats } from "@/game";

/** Graphics settings, the ~1 Hz render readout and the last benchmark, for the graphics debug panel. */
type GraphicsState = {
...
const initialState: GraphicsState = { settings: null, stats: null, benchmark: null, benchmarking: false };
